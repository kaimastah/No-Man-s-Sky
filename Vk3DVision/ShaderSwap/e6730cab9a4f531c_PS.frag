...
void main()
{
    ...
    for (;;)
    {
        ...
        vec4 _962 = vec4(_886.x, _886.y, _980.z, _980.w);
        ...
        vec4 _967 = vec4(_908.x, _908.y, _908.z, _980.w);
        _967.w = 1.0;
        ...
        vec2 _942 = _975 * 0.25;
        _984 = _838.y > 0.75;
        _983 = vec2(_942.x, -_942.y) + vec2(0.5);
        break;
    }
    bool _985;
    if (!_984)
    {
        _985 = (int(texture(gBuffer3Map, In.mTexCoordsVec2).x * 255.0) & 128) != 0;
    }
    else
    {
        _985 = _984;
    }
    out_color0 = vec4(_983, _985 ? 0.5 : 0.0, 1.0);
}
