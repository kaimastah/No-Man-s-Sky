...
void main()
{
    vec4 _176 = mkLocalPositionVec4;
    _176.w = 1.0;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.z, mkTexCoordsVec4.w);
    vec4 _174 = _51.lUniforms.mpPerFrame.gViewProjectionMat4 * (_51.lUniforms.mpCommonPerMesh.gWorldMat4 * _176);
    vec4 _182 = _174;
    _182.z = 0.5 - (max(_174.z, -1.0) * 0.5);
    Out.mScreenSpacePositionVec4 = _182;
    gl_Position = _182;
}
