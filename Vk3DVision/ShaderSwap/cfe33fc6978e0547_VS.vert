...
void main()
{
    vec4 _173 = mkLocalPositionVec4;
    _173.w = 1.0;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.z, mkTexCoordsVec4.w);
    vec4 _171 = _51.lUniforms.mpPerFrame.gViewProjectionMat4 * (_51.lUniforms.mpCommonPerMesh.gWorldMat4 * _173);
    vec4 _179 = _171;
    _179.z = 0.5 - (max(_171.z, -1.0) * 0.5);
    Out.mScreenSpacePositionVec4 = _179;
    gl_Position = _179;
}
