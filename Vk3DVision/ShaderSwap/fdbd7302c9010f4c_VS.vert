...
void main()
{
    vec4 _171 = mkLocalPositionVec4;
    _171.w = 1.0;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.z, mkTexCoordsVec4.w);
    vec4 _169 = _51.lUniforms.mpPerFrame.gViewProjectionMat4 * (_51.lUniforms.mpCommonPerMesh.gWorldMat4 * _171);
    vec4 _177 = _169;
    _177.z = 0.5 - (max(_169.z, -1.0) * 0.5);
    Out.mScreenSpacePositionVec4 = _177;
    gl_Position = _177;
}
