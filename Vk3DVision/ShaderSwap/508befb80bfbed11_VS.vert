...
void main()
{
    ...
    vec4 _416 = _111.lUniforms.mpCommonPerMesh.gWorldMat4 * mkLocalPositionVec4;
    vec3 _158 = normalize((_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkLocalNormalVec4.xyz), 1.0)).xyz);
    Out.mWorldPositionVec3_mfSpare = vec4(_416.x, _416.y, _416.z, Out.mWorldPositionVec3_mfSpare.w);
    Out.mWorldPositionVec3_mfSpare = vec4(_416.x, _416.y, _416.z, Out.mWorldPositionVec3_mfSpare.w);
    vec3 _434 = (_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkTangentVec4.xyz), 1.0)).xyz;
    vec3 _198 = normalize(_434);
    Out.mTangentMatRow1Vec3 = _198;
    vec3 _203 = normalize(cross(_158, _434) * ((mkTangentVec4.w > 0.00999999977648258209228515625) ? 1.0 : (-1.0)));
    ...
    Out.mTangentSpaceEyeVec3 = _243 * normalize(_416.xyz - _111.lUniforms.mpPerFrame.gViewPositionVec3);
...
Out.mTangentSpaceEyeVec3.xyz += vk3d_params.stereo.x * vk3d_params.stereo.y * Out.mTangentSpaceLightDirVec3.xyz * _111.lUniforms.mpPerFrame.gViewProjectionMat4[0].xyz / fov;
    ...
    mat3 _444 = _450;
    _444[0] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[0].xyz;
    mat3 _446 = _444;
    _446[1] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[1].xyz;
    mat3 _448 = _446;
    _448[2] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[2].xyz;
    Out.mUpMatrixMat3 = _448;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.x, mkTexCoordsVec4.y);
    vec4 _442 = _111.lUniforms.mpPerFrame.gViewProjectionMat4 * _416;
    vec2 _316 = _442.xy - ((_111.lUniforms.mpPerFrame.gDeJitterVec3.xy * _442.w) * 2.0);
    vec4 _318 = vec4(_316.x, _316.y, _442.z, _442.w);
