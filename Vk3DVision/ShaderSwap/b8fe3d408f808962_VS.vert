...
void main()
{
    vec4 _172 = mkLocalPositionVec4;
    _172.w = 1.0;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.z, mkTexCoordsVec4.w);
    vec4 _170 = _51.lUniforms.mpPerFrame.gViewProjectionMat4 * (_51.lUniforms.mpCommonPerMesh.gWorldMat4 * _172);
    vec4 _178 = _170;
    _178.z = 0.5 - (max(_170.z, -1.0) * 0.5);
    Out.mScreenSpacePositionVec4 = _178;
    gl_Position = _178;
}
