...
void main()
{
    ...
    vec4 _386 = _109.lUniforms.mpCommonPerMesh.gWorldMat4 * mkLocalPositionVec4;
    vec3 _158 = normalize((_109.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkLocalNormalVec4.xyz), 1.0)).xyz);
    Out.mWorldPositionVec3_mfSpare = vec4(_386.x, _386.y, _386.z, Out.mWorldPositionVec3_mfSpare.w);
    Out.mWorldPositionVec3_mfSpare = vec4(_386.x, _386.y, _386.z, Out.mWorldPositionVec3_mfSpare.w);
    vec3 _408 = (_109.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkTangentVec4.xyz), 1.0)).xyz;
    vec3 _203 = normalize(_408);
    Out.mTangentMatRow1Vec3 = _203;
    vec3 _208 = normalize(cross(_158, _408) * ((mkTangentVec4.w > 0.00999999977648258209228515625) ? 1.0 : (-1.0)));
    ...
    Out.mTangentSpaceEyeVec3 = _249 * normalize(_386.xyz - _109.lUniforms.mpPerFrame.gViewPositionVec3);
...
Out.mTangentSpaceEyeVec3.xyz += vk3d_params.stereo.x * vk3d_params.stereo.y * Out.mTangentSpaceLightDirVec3.xyz * _109.lUniforms.mpPerFrame.gViewProjectionMat4[0].xyz / fov; 
    ...
    vec4 _416 = _109.lUniforms.mpPerFrame.gViewProjectionMat4 * _386;
    Out.mScreenSpacePositionVec4 = _416;
