...
void main()
{
    ...
    vec4 _401 = _111.lUniforms.mpCommonPerMesh.gWorldMat4 * mkLocalPositionVec4;
    vec3 _158 = normalize((_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkLocalNormalVec4.xyz), 1.0)).xyz);
    Out.mWorldPositionVec3_mfSpare = vec4(_401.x, _401.y, _401.z, Out.mWorldPositionVec3_mfSpare.w);
    Out.mWorldPositionVec3_mfSpare = vec4(_401.x, _401.y, _401.z, Out.mWorldPositionVec3_mfSpare.w);
    vec3 _419 = (_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkTangentVec4.xyz), 1.0)).xyz;
    vec3 _198 = normalize(_419);
    Out.mTangentMatRow1Vec3 = _198;
    vec3 _203 = normalize(cross(_158, _419) * ((mkTangentVec4.w > 0.00999999977648258209228515625) ? 1.0 : (-1.0)));
    ...
    Out.mTangentSpaceEyeVec3 = _243 * normalize(_401.xyz - _111.lUniforms.mpPerFrame.gViewPositionVec3);
...
Out.mTangentSpaceEyeVec3.xyz += vk3d_params.stereo.x * vk3d_params.stereo.y * Out.mTangentSpaceLightDirVec3.xyz * _111.lUniforms.mpPerFrame.gViewProjectionMat4[0].xyz / fov;
    ...
    mat3 _429 = _434;
    _429[0] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[0].xyz;
    mat3 _431 = _429;
    _431[1] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[1].xyz;
    mat3 _433 = _431;
    _433[2] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[2].xyz;
    Out.mUpMatrixMat3 = _433;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.x, mkTexCoordsVec4.y);
    vec4 _427 = _111.lUniforms.mpPerFrame.gViewProjectionMat4 * _401;
    Out.mScreenSpacePositionVec4 = _427;
