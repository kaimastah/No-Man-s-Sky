...
void main()
{
    ...
    vec4 _417 = _111.lUniforms.mpCommonPerMesh.gWorldMat4 * mkLocalPositionVec4;
    vec3 _158 = normalize((_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkLocalNormalVec4.xyz), 1.0)).xyz);
    Out.mWorldPositionVec3_mfSpare = vec4(_417.x, _417.y, _417.z, Out.mWorldPositionVec3_mfSpare.w);
    Out.mWorldPositionVec3_mfSpare = vec4(_417.x, _417.y, _417.z, Out.mWorldPositionVec3_mfSpare.w);
    vec3 _435 = (_111.lUniforms.mpCommonPerMesh.gWorldNormalMat4 * vec4(normalize(mkTangentVec4.xyz), 1.0)).xyz;
    vec3 _198 = normalize(_435);
    Out.mTangentMatRow1Vec3 = _198;
    vec3 _203 = normalize(cross(_158, _435) * ((mkTangentVec4.w > 0.00999999977648258209228515625) ? 1.0 : (-1.0)));
    ...
    Out.mTangentSpaceEyeVec3 = _243 * normalize(_417.xyz - _111.lUniforms.mpPerFrame.gViewPositionVec3);
...
Out.mTangentSpaceEyeVec3.xyz += vk3d_params.stereo.x * vk3d_params.stereo.y * Out.mTangentSpaceLightDirVec3.xyz * _111.lUniforms.mpPerFrame.gViewProjectionMat4[0].xyz / fov;
    ...
    mat3 _445 = _451;
    _445[0] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[0].xyz;
    mat3 _447 = _445;
    _447[1] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[1].xyz;
    mat3 _449 = _447;
    _449[2] = _111.lUniforms.mpPerFrame.gInverseWorldUpMatVec4[2].xyz;
    Out.mUpMatrixMat3 = _449;
    Out.mTexCoordsVec4 = vec4(mkTexCoordsVec4.x, mkTexCoordsVec4.y, mkTexCoordsVec4.x, mkTexCoordsVec4.y);
    vec4 _443 = _111.lUniforms.mpPerFrame.gViewProjectionMat4 * _417;
    vec2 _316 = _443.xy - ((_111.lUniforms.mpPerFrame.gDeJitterVec3.xy * _443.w) * 2.0);
    vec4 _318 = vec4(_316.x, _316.y, _443.z, _443.w);
    Out.mScreenSpacePositionVec4 = _318;
